    ...
    def __getitem__(self, index):
        ...
        for frame_info in video_info['data']:
            ...
            for m, skeleton_info in enumerate(frame_info["skeleton"]):
                ...
                data_numpy[0, frame_index, :, m] = list((np.array(pose[0::2]) / 1920) - pose[2])
                data_numpy[1, frame_index, :, m] = list((np.array(pose[1::2]) / 1080) - pose[3])
    ...
    for age in age_list:
        for act in range(1,5):
            for p in part:
                ...
                if not os.path.exists(f'{arg.out_folder}/{age}/{act}'):
                    os.makedirs(f'{arg.out_folder}/{age}/{act}')
                data_path = '{}/{}/{}/{}'.format(arg.data_path, age, act, p)
                label_path = '{}/{}/{}/{}_label.json'.format(arg.data_path, age, act, p)
                data_out_path = '{}/{}/{}/{}_data_joint.npy'.format(arg.out_folder, age, act, p)
                label_out_path = '{}/{}/{}/{}_label.pkl'.format(arg.out_folder, age, act, p)
